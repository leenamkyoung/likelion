"""
Django settings for postproject project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '1r87s#1!9xdj%4y%i@o@w7p==+&a(nl-$m7=ue*gz1&okj$+&x')
...
WSGI_APPLICATION = 'postproject.wsgi.application'
